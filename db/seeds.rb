...
carbon_based = Release.create(
  title: 'Carbon Based',
  cover: File.new("#{Rails.root}/app/assets/images/releases/hmrl_001.jpg"),
...
bernays_propaganda = Artist.create(
  ...
  image: File.new("#{Rails.root}/app/assets/images/artists/bernays_propaganda_01.jpg"),
  description: 'TODO: ',
  origin: 'Macedonia',
  songkick_id: 2459271,
  active: true,
...
politika = Release.create(
  title: 'Politika',
  cover: File.new("#{Rails.root}/app/assets/images/releases/hmrl_039.jpg"),
...
damir_avdic = Artist.create(
  name: 'Damir Avdić',
  image: File.new("#{Rails.root}/app/assets/images/artists/damir_avdic_01.jpg"),
  description: 'TODO',
...
zivot_je_raj = Release.create(
  title: 'Život je Raj',
  cover: File.new("#{Rails.root}/app/assets/images/releases/hmrl_019.jpg"),
...
repetitor = Artist.create(
  name: 'Repetitor',
  image: File.new("#{Rails.root}/app/assets/images/artists/repetitor_01.jpg"),
...
dobrodosli_na_okean = Release.create(
  ...
  cover: File.new("#{Rails.root}/app/assets/images/releases/hmrl_028.jpg"),
...
xaxaxa = Artist.create(
  name: 'Xaxaxa',
  image: File.new("#{Rails.root}/app/assets/images/artists/xaxaxa_01.jpg"),
  description: 'TODO: ',
  origin: 'Macedonia',
  active: false,
  formed: '2009',
