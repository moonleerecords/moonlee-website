...
ActiveRecord::Schema.define(version: 20201024104920) do
  ...
  create_table "artist_members", force: :cascade do |t|
    ...
    t.index ["member_id"], name: "index_artist_members_on_member_id"
  end
  ...
  create_table "external_links", force: :cascade do |t|
    ...
    t.index ["artist_id"], name: "index_external_links_on_artist_id"
  ...
  create_table "release_type_buy_links", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["release_type_id"], name: "index_release_type_buy_links_on_release_type_id"
  end
  ...
  create_table "release_types", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["release_id"], name: "index_release_types_on_release_id"
  end
