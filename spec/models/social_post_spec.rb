...
RSpec.describe SocialPost, type: :model do
  context 'on saving' do
    it 'should save SocialPost if all validations pass' do
      ...
      social_post.link = 'https://instagram.flju1-1.fna.fbcdn.net/t51.2885-15/s320x320/e35/14659235_183405935400735_5440615191886692352_n.jpg?ig_cache_key=MTM1NzI3MzA5OTI2NzE5NjMzOA%3D%3D.2'
